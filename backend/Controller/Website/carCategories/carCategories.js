...
const getCarCategories = async (req, res) => {
  const sql = "SELECT rv.carName, rv.brand, rv.model,rv.modelYear,rv.image, c.city_name,c.state_name ,rv.seat,rv.fuelType FROM registered_vehicle rv JOIN city_list c ON rv.loc_id = c.loc_id;"; 
  try {
