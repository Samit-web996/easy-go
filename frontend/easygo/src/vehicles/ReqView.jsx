        ...
        <div className="p-6 space-y-6">
          {vehicleInfo.image && (
            <div className="relative group w-full h-56 sm:h-72 rounded-xl overflow-hidden shadow-lg bg-gray-100 dark:bg-gray-900 border border-gray-200/50 dark:border-white/5 mb-2">
              <img
                src={
                  vehicleInfo.image?.startsWith("http")
                    ? vehicleInfo.image
                    : `${IMAGE_BASE_URL}/uploads/${vehicleInfo.image}`
                }
                alt="vehicle"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="p-5 rounded-xl bg-gray-50/50 dark:bg-[#161b22]/40 border border-gray-100 dark:border-gray-800/60 sm:col-span-2 space-y-3">
              <h3 className="text-xs font-bold tracking-wider uppercase text-blue-600 dark:text-blue-400">
                Host & Ownership
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm pt-1">
                <p className="flex flex-col sm:flex-row sm:gap-2">
                  <span className="text-gray-400 font-medium">Name on RC:</span>{" "}
            ...
            <div className="p-5 rounded-xl bg-gray-50/50 dark:bg-[#161b22]/40 border border-gray-100 dark:border-gray-800/60 space-y-3 text-sm">
              ...
              <div className="space-y-1">
                <p className="flex justify-between border-b border-gray-100 dark:border-gray-800/80 py-2">
                  <span className="text-gray-400">Reg Num:</span>{" "}
                  <span className="font-mono font-bold tracking-wider text-gray-900 dark:text-white">
                    {vehicleInfo.registrationNum}
                  </span>
                </p>
                <p className="flex justify-between border-b border-gray-100 dark:border-gray-800/80 py-2">
                ...
                <p className="flex justify-between border-b border-gray-100 dark:border-gray-800/80 py-2">
                  <span className="text-gray-400">Brand Family:</span>{" "}
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {vehicleInfo.brand}
                  </span>
                </p>
                <p className="flex justify-between py-2">
                  ...
                  <span className="font-medium text-gray-900 dark:text-gray-100 text-right max-w-[150px] truncate">
                    {vehicleInfo.model}
                  </span>
                </p>
              </div>
            ...
            <div className="p-5 rounded-xl bg-gray-50/50 dark:bg-[#161b22]/40 border border-gray-100 dark:border-gray-800/60 space-y-3 text-sm">
              ...
              <div className="space-y-1">
                <p className="flex justify-between border-b border-gray-100 dark:border-gray-800/80 py-2">
                  <span className="text-gray-400">Seat Configuration:</span>{" "}
                  <span className="font-medium text-gray-900 dark:text-gray-100">
                    {vehicleInfo.seat} Seater
                  </span>
                </p>
                <p className="flex justify-between border-b border-gray-100 dark:border-gray-800/80 py-2">
                  <span className="text-gray-400">Fuel Setup:</span>{" "}
                  <span className="font-medium text-gray-900 dark:text-gray-100">
            ...
            <div className="p-5 rounded-xl bg-gray-50/50 dark:bg-[#161b22]/40 border border-gray-100 dark:border-gray-800/60 sm:col-span-2 space-y-4 text-sm">
              <div>
                <h4 className="text-xs font-bold tracking-wider uppercase text-blue-600 dark:text-blue-400 mb-1.5">
                  Features Included
                </h4>
                <p className="text-gray-600 dark:text-gray-300 text-xs leading-relaxed bg-white dark:bg-[#0d1117] p-3 rounded-lg border border-gray-100 dark:border-gray-800/40">
                  {vehicleInfo.features || "Standard Features applied"}
                </p>
              </div>
              ...
              <div className="pt-1">
                ...
                <p className="font-medium flex items-center gap-2 text-gray-700 dark:text-gray-300 bg-white dark:bg-[#0d1117] p-3 rounded-lg border border-gray-100 dark:border-gray-800/40">
                  ...
                  <span className="text-gray-900 dark:text-gray-100">
                    {vehicleInfo.city_name || "Location not available"}
                  </span>
                </p>
              </div>
