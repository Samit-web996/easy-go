...
const AdminNavbar = () => {
  ...
  return (
    <nav className="bg-zinc-900 text-white shadow-lg w-screen h-18">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          {/* Logo Section */}
          <div className="flex items-center">
            {/* <div className="flex-shrink-0 flex items-center gap-2">
              <span className="text-2xl font-bold text-blue-500">EasyGo</span>
              <span className="text-2xl font-light">Cars</span>
            </div> */}
          </div>
